<header class="h-24">
    <nav>
        <div class="nav-wrapper container flex items-center justify-between">
            <div>
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    @if(1==1)
                        ...
                        <li class="mx-auto my-auto">
                            <img class="h-10 w-10 rounded-full" src="{{asset('image/02.jpg')}}">
                        </li>
                    @else
...
{{--                        <ul id="dropdown1" class="dropdown-content">--}}
{{--                            <li><a href="#!"><i class="material-icons">view_module</i>one</a></li>--}}
{{--                            <li><a href="#!">two</a></li>--}}
{{--                            <li class="divider"></li>--}}
{{--                            <li><a href="#!">three</a></li>--}}
{{--                        </ul>--}}
...
{{--        <ul class="nav-wrapper sidenav" id="nav-mobile">--}}
