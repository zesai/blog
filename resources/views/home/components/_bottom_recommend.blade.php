<section>
    <div class="flex items-center justify-between leading-loose mb-1">
        <div class="font-bold text-2xl text-gray-800 tracking-normal">推荐资源</div>
        <div>
            <a href="javascript:;">
                <i class="material-icons text-gray-800 ">more_vert</i>
            </a>
        </div>
    </div>
