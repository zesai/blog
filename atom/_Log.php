...
{
 	 return (new Illuminate\Log\LogManager)->getChannels();
}
/**
 ...
 * @return static|$this
 */
static public function forgetChannel ( $driver =NULL)  
{
 	 return (new Illuminate\Log\LogManager)->forgetChannel($driver);
}
/**
 * System is unusable.
 *
