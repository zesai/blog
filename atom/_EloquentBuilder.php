 ...
 */
static public function firstWhere ( $column , $operator =NULL, $value =NULL, $boolean ='and')  
{
 	 return (new Illuminate\Database\Eloquent\Builder)->firstWhere($column,$operator,$value,$boolean);
}
/**
 ...
 */
static public function firstOrNew (array $attributes =array (),array $values =array ())  
{
 ...
 * @return bool
 */
static public function hasNamedScope ( $scope )  
{
 	 return (new Illuminate\Database\Eloquent\Builder)->hasNamedScope($scope);
}
/**
 ...
 * @return static|$this
 */
static public function withCasts ( $casts )  
{
 	 return (new Illuminate\Database\Eloquent\Builder)->withCasts($casts);
}
/**
...
{
 	 return (new Illuminate\Database\Eloquent\Builder)->hasMacro($name);
}
/**
 ...
 * @return \Closure
 */
static public function getGlobalMacro ( $name )  
{
 	 return (new Illuminate\Database\Eloquent\Builder)->getGlobalMacro($name);
}
/**
 ...
 * @return bool
 */
static public function hasGlobalMacro ( $name )  
{
 	 return (new Illuminate\Database\Eloquent\Builder)->hasGlobalMacro($name);
}
/**
