 ...
 */
static public function getRawPdo ()  
{
 	 return (new Illuminate\Database\MySqlConnection)->getRawPdo();
}
/**
 ...
 * @return \PDO|\Closure|null
 */
static public function getRawReadPdo ()  
{
 	 return (new Illuminate\Database\MySqlConnection)->getRawReadPdo();
}
/**
