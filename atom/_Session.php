 ...
 * @return bool
 */
static public function shouldBlock ()  
{
 	 return (new Illuminate\Session\SessionManager)->shouldBlock();
}
/**
 ...
 * @return string|null
 */
static public function blockDriver ()  
{
 	 return (new Illuminate\Session\SessionManager)->blockDriver();
}
/**
