 ...
 * @return void
 */
static public function startComponent ( $view ,array $data =array ())  
{
 	 return (new Illuminate\View\Factory)->startComponent($view,$data);
}
/**
 ...
 * @return bool
 */
static public function sectionMissing ( $name )  
{
 	 return (new Illuminate\View\Factory)->sectionMissing($name);
}
/**
