 ...
 * @return array
 */
static public function mergeWithLastGroup ( $new , $prependExistingPrefix =true)  
{
 	 return (new Illuminate\Routing\Router)->mergeWithLastGroup($new,$prependExistingPrefix);
}
/**
 ...
 * @return \Illuminate\Routing\Route
 */
static public function newRoute ( $methods , $uri , $action )  
{
 	 return (new Illuminate\Routing\Router)->newRoute($methods,$uri,$action);
}
/**
 ...
 * @return void
 */
static public function setCompiledRoutes (array $routes )  
{
 	 return (new Illuminate\Routing\Router)->setCompiledRoutes($routes);
}
/**
