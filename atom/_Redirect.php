 ...
 * @return \Illuminate\Http\RedirectResponse
 */
static public function signedRoute ( $route , $parameters =array (), $expiration =NULL, $status =302, $headers =array ())  
{
 	 return (new Illuminate\Routing\Redirector)->signedRoute($route,$parameters,$expiration,$status,$headers);
}
/**
 * Create a new redirect response to a signed named route.
 *
 ...
 * @return \Illuminate\Http\RedirectResponse
 */
static public function temporarySignedRoute ( $route , $expiration , $parameters =array (), $status =302, $headers =array ())  
{
 	 return (new Illuminate\Routing\Redirector)->temporarySignedRoute($route,$expiration,$parameters,$status,$headers);
}
/**
