 ...
 * @return static
 */
static public function create (string $uri ,string $method ='GET',array $parameters =array (),array $cookies =array (),array $files =array (),array $server =array (), $content =NULL)  
{
 ...
 * other purpose.
 */
static public function setFactory (callable $callable )  
{
 ...
 */
static public function normalizeQueryString (string $qs )  
{
 ...
 */
static public function getUriForPath (string $path )  
{
 ...
 */
static public function getRelativeUriForPath (string $path )  
{
 ...
 */
static public function setMethod (string $method )  
{
 ...
 */
static public function getMimeType (string $format )  
{
 ...
 */
static public function getMimeTypes (string $format )  
{
 ...
 */
static public function getFormat (string $mimeType )  
{
 ...
 */
static public function setFormat (string $format , $mimeTypes )  
{
 ...
 */
static public function getRequestFormat (string $default ='html')  
{
 ...
 */
static public function setRequestFormat (string $format )  
{
 ...
 */
static public function setDefaultLocale (string $locale )  
{
 ...
 * @return bool
 */
static public function isMethod (string $method )  
{
 ...
 */
static public function getContent (bool $asResource =false)  
{
 ...
 */
static public function preferSafeContent ()  : bool 
{
 	 return (new Illuminate\Http\Request)->preferSafeContent();
}
/**
 ...
 * @return bool
 */
static public function missing ( $key )  
{
 	 func_get_args();
	 return (new Illuminate\Http\Request)->missing($key);
}
/**
 ...
 * @return bool
 */
static public function boolean ( $key =NULL, $default =false)  
{
 	 return (new Illuminate\Http\Request)->boolean($key,$default);
}
/**
