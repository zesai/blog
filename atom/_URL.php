 ...
 * @return void
 */
public function __construct (Illuminate\Routing\RouteCollectionInterface $routes ,Illuminate\Http\Request $request , $assetRoot =NULL)  
{
 ...
 * @return bool
 */
static public function hasCorrectSignature (Illuminate\Http\Request $request , $absolute =true)  
{
 	 return (new Illuminate\Routing\UrlGenerator)->hasCorrectSignature($request,$absolute);
}
/**
 ...
 * @return bool
 */
static public function signatureHasNotExpired (Illuminate\Http\Request $request )  
{
 	 return (new Illuminate\Routing\UrlGenerator)->signatureHasNotExpired($request);
}
/**
 ...
 * @return static|$this
 */
static public function setRoutes (Illuminate\Routing\RouteCollectionInterface $routes )  
{
