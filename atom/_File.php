 ...
 * @return bool
 */
static public function missing ( $path )  
{
 	 return (new Illuminate\Filesystem\Filesystem)->missing($path);
}
/**
...
{
 	 return (new Illuminate\Filesystem\Filesystem)->guessExtension($path);
}
/**
 ...
 * @return void
 */
static public function ensureDirectoryExists ( $path , $mode =493, $recursive =true)  
{
 	 return (new Illuminate\Filesystem\Filesystem)->ensureDirectoryExists($path,$mode,$recursive);
}
/**
 * Create a directory.
 *
