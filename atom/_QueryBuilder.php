 ...
 * @return static
 */
static public function whereNotNull ( $columns , $boolean ='and')  
{
 	 return (new Illuminate\Database\Query\Builder)->whereNotNull($columns,$boolean);
}
/**
 ...
 * @return static|$this
 */
static public function groupByRaw ( $sql ,array $bindings =array ())  
{
 	 return (new Illuminate\Database\Query\Builder)->groupByRaw($sql,$bindings);
}
/**
 ...
 * @return mixed
 */
static public function existsOr (Closure $callback )  
{
 	 return (new Illuminate\Database\Query\Builder)->existsOr($callback);
}
/**
 ...
 * @return mixed
 */
static public function doesntExistOr (Closure $callback )  
{
 	 return (new Illuminate\Database\Query\Builder)->doesntExistOr($callback);
}
/**
